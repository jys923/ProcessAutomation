...
namespace Hsnlibrary
{
	...
	extern HSNLIBRARYEND_API bool getMainboardSN(std::string& value);
	extern HSNLIBRARYEND_API bool getLibraryVersion(std::string& value);
	...
	extern HSNLIBRARYEND_API int calibrateDeviceCapsuleScanline(int offset);
}