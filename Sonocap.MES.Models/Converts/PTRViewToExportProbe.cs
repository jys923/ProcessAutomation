    ...
    public static class PTRViewToExportProbe
    {
        private static ExportProbe Convert(PTRView ptrView)
        {
            ...
            return new ExportProbe
            {
                ...
                Date2 = ptrView.Test02.CreatedDate,
                Score2 = ptrView.Test02.Result,
                Date3 = ptrView.Test03.CreatedDate,
                Score3 = ptrView.Test03.Result,
                Date4 = ptrView.Test04.CreatedDate,
                Score4 = ptrView.Test04.Result,
                Date5 = ptrView.Test05.CreatedDate,
                Score5 = ptrView.Test05.Result,
                Date6 = ptrView.Test06.CreatedDate,
                Score6 = ptrView.Test06.Result,
