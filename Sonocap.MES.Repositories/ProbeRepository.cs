...
";
        ...
        public async Task<List<ProbeTestResult>> GetProbeTestResultAsync(DateTime? startDate, DateTime? endDate, string? probeSn, string? transducerModuleSn, string? transducerSn, string? motorModuleSn)
        {
            ...
            var probeTestResults = result.Select(p => new ProbeTestResult
            {
                ...
                Test1_CreatedDate = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test1_Result = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test2_CreatedDate = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test2_Result = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test3_CreatedDate = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test3_Result = _context.Set<Test>().Where(t => t.TransducerId == p.TransducerId && t.TestCategoryId == 1 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test4_CreatedDate = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test4_Result = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test5_CreatedDate = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test5_Result = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test6_CreatedDate = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test6_Result = _context.Set<Test>().Where(t => t.TransducerModuleId == p.TransducerModuleId && t.TestCategoryId == 2 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test7_CreatedDate = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test7_Result = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 1 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test8_CreatedDate = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test8_Result = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 2 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
                ...
                Test9_CreatedDate = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.CreatedDate).FirstOrDefault(),
                Test9_Result = _context.Set<Test>().Where(t => t.ProbeId == p.ProbeId && t.TestCategoryId == 3 && t.TestTypeId == 3 && t.DataFlag == 1).OrderByDescending(t => t.Id).Select(t => t.Result).FirstOrDefault(),
            }).ToList();
