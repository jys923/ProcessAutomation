        ...
        public List<ProbeTestResult> GetProbeTestResult()
        {
            ...
            IQueryable<ProbeTestResult> probeTestResults =
                ...
                select new ProbeTestResult
                {
                    ...
                    {
                        // Test 결과 추가
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t1.CategoryId, TypeId = (Models.Base.TestType)t1.TestTypeId, CreatedDate = t1.CreatedDate, Result = t1.ChangedImgMetadata},
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t2.CategoryId, TypeId = (Models.Base.TestType)t2.TestTypeId, CreatedDate = t2.CreatedDate, Result = t2.ChangedImgMetadata},
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t3.CategoryId, TypeId = (Models.Base.TestType)t3.TestTypeId, CreatedDate = t3.CreatedDate, Result = t3.ChangedImgMetadata},
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t4.CategoryId, TypeId = (Models.Base.TestType)t4.TestTypeId, CreatedDate = t4.CreatedDate, Result = t4.ChangedImgMetadata},
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t5.CategoryId, TypeId = (Models.Base.TestType)t5.TestTypeId, CreatedDate = t5.CreatedDate, Result = t5.ChangedImgMetadata},
                        new TestResult { CategoryId = (SonoCap.MES.Models.Base.TestCategory)t6.CategoryId, TypeId = (Models.Base.TestType)t6.TestTypeId, CreatedDate = t6.CreatedDate, Result = t6.ChangedImgMetadata},
                    }
                };
