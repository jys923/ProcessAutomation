...
namespace SonoCapUsImgTest
{
    ...
    public delegate void Loading(bool value);
    ...
    public static class SonoCapUsImgService
    {
        ...
        [DllImport(DllName, EntryPoint = nameof(ForTest), ExactSpelling = true, CharSet = CharSet.None, CallingConvention = CallingConvention.Cdecl)]
        public static extern double ForTest(int length);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool HsnBufferCreatorInitialize();

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern void HsnBufferCreatorGetBitmapBuffer();
